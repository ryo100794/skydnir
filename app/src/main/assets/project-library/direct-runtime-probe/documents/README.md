...
`/documents/skydnir-exports/direct-runtime-probe/latest.log`

and a machine-readable summary to:

`/documents/skydnir-exports/direct-runtime-probe/latest.json`

Do not put hot build caches, compiler temporary files, package-manager caches,
or tight test loops here. Keep those under `/workspace` or app-private runtime
storage, then copy selected results to `/documents/skydnir-exports`.
