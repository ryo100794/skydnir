...
FAIL_BRANCHES = [
    ...
    {
        "condition": "q6_compat_rewrites.summary == missing-or-incomplete",
        "action": "fix structural Q6 compat rewrite evidence before interpreting native final-store results",
        "owner": "Q6 structural compat rewrite gate",
    },
    {
