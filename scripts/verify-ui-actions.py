...
def main() -> int:
    ...
    require("direct executor maps restricted proc files to synthetic proc", "ensure_synthetic_proc_files" in pdockerd_src and 'strcmp(guest, "/proc/stat") == 0' in direct_src and 'strcmp(guest, "/proc/uptime") == 0' in direct_src and 'strcmp(guest, "/proc/loadavg") == 0' in direct_src and '.pdocker-proc/%s' in direct_src)
    ...
    require("terminal input normalizes ime enter and releases one-shot modifiers", "normalizeTerminalInput" in xterm_src and "replace(/\\r\\n/g, '\\r').replace(/\\n/g, '\\r')" in xterm_src and "clearTransientModifiers" in xterm_src and "scheduleModifierClear" in xterm_src and "claimImeEvent" in xterm_src and "stopImmediatePropagation" in xterm_src and "installHelperInputFallback" in xterm_src and "inputType === 'insertLineBreak'" in xterm_src and "suppressTerminalDataOnce(event.data)" in xterm_src and "consumeSuppressedTerminalData(data)" in xterm_src and "window.pdockerTestSendInput" in xterm_src and "window.pdockerTestCtrlInput" in xterm_src and "pdocker-ui-it-ctrlc-ok" in main_src)
