...
def main() -> int:
    ...
    require("gpu descriptor alias materialization option is propagated", "PDOCKER_GPU_MATERIALIZE_DESCRIPTOR_ALIASES" in gpu_executor_src and "materialize_descriptor_aliases" in gpu_executor_src and "PDOCKER_GPU_MATERIALIZE_DESCRIPTOR_ALIASES" in vulkan_icd_src and "materialize_descriptor_aliases=" in vulkan_icd_src and "PDOCKER_GPU_MATERIALIZE_DESCRIPTOR_ALIASES" in pdockerd_src and "PDOCKER_GPU_MATERIALIZE_DESCRIPTOR_ALIASES" in llama_gpu_env_manifest_src)
    require("gpu resident cache can be disabled from tests through icd and executor", "PDOCKER_GPU_RESIDENT_CACHE" in llama_gpu_env_manifest_src and "PDOCKER_GPU_RESIDENT_CACHE" in vulkan_icd_src and "resident_cache=" in vulkan_icd_src and "resident_cache_candidate(options" in gpu_executor_src and "PDOCKER_GPU_RESIDENT_CACHE" in pdockerd_src)
    require("q6k oracle writeback diagnostic is explicitly gated and propagated", "PDOCKER_GPU_Q6K_ORACLE_WRITEBACK" in llama_gpu_env_manifest_src and "PDOCKER_GPU_Q6K_ORACLE_WRITEBACK" in vulkan_icd_src and "q6k_oracle_writeback=" in vulkan_icd_src and "oracle_writeback_rows" in gpu_executor_src and "PDOCKER_GPU_Q6K_ORACLE_WRITEBACK" in pdockerd_src)
    require("q6k safe gpu kernel is explicitly gated and propagated", "PDOCKER_GPU_Q6K_SAFE_KERNEL" in llama_gpu_env_manifest_src and "PDOCKER_GPU_Q6K_SAFE_KERNEL" in vulkan_icd_src and "q6k_safe_kernel=" in vulkan_icd_src and "kQ6kSafeSpv" in gpu_executor_src and "q6k_safe_kernel" in gpu_executor_src and "PDOCKER_GPU_Q6K_SAFE_KERNEL" in pdockerd_src)
