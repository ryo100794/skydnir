...
def main() -> int:
    ...
    require("images tab renders reference graph with sizes", "renderImageReferenceTree" in main_src and "imageParentMap" in main_src and "uniqueLayerBytes" in main_src and "sharedLayerBytes" in main_src and "addImageReferenceGraph" in main_src and "ImageReferenceGraphRow" in main_src and "addImageGraphBranchCell" in main_src and "image_reference_legend_image" in string_src and "image_storage_detail_fmt" in string_src)
