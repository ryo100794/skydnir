...
def main() -> int:
    ...
    require("llama template migration installs KV offload guard", "PDOCKER_VULKAN_ALLOW_KV_OFFLOAD" in main_src and "--no-kv-offload" in main_src and ".pdocker-template-version\").writeText(\"7" in main_src)
