...
def main() -> int:
    ...
    require("container exposes explicit engine api it terminal", "action_container_terminal_fmt" in string_src and "detail_container_terminal" in string_src and "ENGINE_EXEC_PREFIX" in main_src and "engineExecTerminalCommand" in main_src and "/exec/$execId/start" in bridge_src_now and 'import org.json.JSONArray' in bridge_src_now and '"Cmd", JSONArray(listOf("/bin/sh", "-i"))' in bridge_src_now and '"Env", JSONArray(listOf("ENV=", "BASH_ENV="))' in bridge_src_now and "docker exec -it" not in main_src)
    ...
    require("android device smoke covers ui bridge it self-test", "ACTION_SMOKE_UI_IT_SELFTEST" in main_src and "runUiItSelfTest" in main_src and "ui-it-selftest-latest.json" in main_src and "ui_engine_exec_it_selftest" in android_smoke_src and "SMOKE_UI_IT_SELFTEST" in android_smoke_src and "pdocker-ui-it-ok" in main_src and "pdocker-ui-it-bracket-ok" in main_src and "pdocker-ui-it-ctrlc-ok" in main_src and "window.pdockerTestSendInput" in main_src)
