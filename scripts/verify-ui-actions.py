...
def main() -> int:
    ...
    require("images tab renders colored reference tree with sizes", "renderImageReferenceTree" in main_src and "imageParentMap" in main_src and "uniqueLayerBytes" in main_src and "sharedLayerBytes" in main_src and "addColoredTextBlock" in main_src and "image_reference_legend" in string_src and "image_storage_detail_fmt" in string_src)
