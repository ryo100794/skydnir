...
def main() -> int:
    ...
    require("vulkan icd has opt-in copy alias fast path", "PDOCKER_VULKAN_ALIAS_COPIES" in vulkan_icd_src and "if (copy_alias_enabled())" in vulkan_icd_src and "descriptor alias binding" in vulkan_icd_src and "copy-alias" in vulkan_icd_src and "\"PDOCKER_VULKAN_ALIAS_COPIES\"," in (ROOT / "scripts/android-llama-gpu-compare.sh").read_text())
