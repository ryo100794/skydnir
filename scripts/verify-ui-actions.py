...
def main() -> int:
    ...
    require("llama template migration refreshes implicit OpenBLAS detection", "staleOpenBlasDetection" in main_src and "-DBLAS_LIBRARIES=\\\"\\$openblas_lib\\\"" in main_src and "pkg-config --variable=libdir openblas" in main_src)
