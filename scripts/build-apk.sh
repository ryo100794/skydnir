...
: "${PDOCKER_ANDROID_FLAVOR:=${SKYDNIR_ANDROID_FLAVOR:-compat}}"
: "${PDOCKER_ANDROID_BUILD_TYPE:=${SKYDNIR_ANDROID_BUILD_TYPE:-debug}}"
: "${PDOCKER_SKIP_NATIVE_BUILD:=${SKYDNIR_SKIP_NATIVE_BUILD:-0}}"
export SKYDNIR_ANDROID_FLAVOR="$PDOCKER_ANDROID_FLAVOR"
export SKYDNIR_ANDROID_BUILD_TYPE="$PDOCKER_ANDROID_BUILD_TYPE"
export SKYDNIR_SKIP_NATIVE_BUILD="$PDOCKER_SKIP_NATIVE_BUILD"
