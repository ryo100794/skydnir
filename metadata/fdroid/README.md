...
`generated-binary-inventory.md` is a support inventory for the host-only
readiness check. It is not active F-Droid build metadata; use it with the
canonical release process rather than duplicating source, license,
reproducibility, anti-feature, or generated-artifact rules here.
