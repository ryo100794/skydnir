...
| [`LLAMA_GPU_Q6_LANE_TRACE_20260601.md`](LLAMA_GPU_Q6_LANE_TRACE_20260601.md) | 2026-06-01 Q6 lane trace evidence and investigation notes for non-promoting llama GPU diagnostics |
| [`llama-gpu-midpoint-20260622T221449Z.md`](llama-gpu-midpoint-20260622T221449Z.md) | 2026-06-22 llama GPU midpoint evidence for Q6 source SPIR-V locator and next-run probe workflow |
