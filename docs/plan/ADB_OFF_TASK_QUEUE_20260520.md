...
ADBOFF-001 through ADBOFF-036 have landed. Keep this table as the
...
| ADBOFF-006 | P1 | Maintain this ADB-off queue and plan index. | This document remains linked from `docs/plan/README.md` and referenced by the coordination ledger. | Ongoing maintenance; current queue items ADBOFF-001 through ADBOFF-036 have landed. |
