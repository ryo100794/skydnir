...
image/view objects from V6.1 metadata, materialize read-only vertex buffers, and record a supported unindexed draw command-buffer subset, and submit it to the graphics queue, but attachment writeback remains
