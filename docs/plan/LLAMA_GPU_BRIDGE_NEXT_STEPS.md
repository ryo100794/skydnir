...
Residual graphics gaps remain explicit: dual-aspect packed depth/stencil
...
transfer, dispatch inside an active rendering scope, and broader synchronization are still
