...
- Barrier1 and barrier2 fixtures cover fd-backed color, pure-depth, and
  ...
  CPU producer evidence for the barrier2 side of this slice is recorded in
  `tests.test_vulkan_icd_sync_harness`; barrier1/device replay evidence remains
  separate from this CPU-only update.
