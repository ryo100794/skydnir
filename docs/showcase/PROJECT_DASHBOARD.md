...
Source snapshot: `2026-05-05T05:58:02Z`.
...
| next | SAF/Documents boundary: a user-selected Android Documents directory is an explicit `/documents` exchange mount only. Hot runtime paths, model files, caches, layer data, and project... |
