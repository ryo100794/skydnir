...
| Category | Count |
|---|---:|
| `android_ui_or_package_surface` | 202 |
| `artifact_schema` | 340 |
| `cli_command` | 30 |
| `config_path` | 133 |
| `daemon_binary_or_service` | 549 |
| `documentation_reference` | 182 |
| `environment_variable` | 2808 |
| `historical_evidence` | 11005 |
| `internal_reference` | 1941 |
