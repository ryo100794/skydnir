    ...
    def synthetic_pass_artifact(self):
            ...
            cases.append(
                {
                    ...
                    "CheckpointToken": required["Step"],
                    "CheckpointAckFile": "device-evidence/" + required["Id"] + "/checkpoint.pid",
                    "PreKillStateFile": "device-evidence/" + required["Id"] + "/pre-kill.json",
                    "KilledPid": 12345,
                    ...
                    "RestartEvidenceFile": "device-evidence/" + required["Id"] + "/restart.json",
                    "MergedViewVerified": True,
                    "FailureOracleMatched": True,
                    "PostRestartStateFile": "device-evidence/" + required["Id"] + "/post-restart.json",
                    "Proof": proof,
        ...
        return {
            ...
            "artifact_contract": {
                ...
                "pass_requires_external_helper": "files/pdocker/tools/pdocker-cow-kill-at-step",
                "pass_forbids_name_based_kill": True,
                "required_case_fields": sorted(mod.REQUIRED_PASS_CASE_FIELDS),
            },
