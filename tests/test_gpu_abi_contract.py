...
class GpuAbiContractTest(unittest.TestCase):
    ...
    def test_vulkan_compute_dispatch_executor_work_tables_are_heap_backed_for_v5_width(self):
        ...
        self.assertIn("used = (uint8_t *)calloc(binding_capacity, sizeof(uint8_t));", rewrite_body)
        self.assertIn("first_seen = (uint8_t *)calloc(binding_capacity, sizeof(uint8_t));", rewrite_body)
